...
- `python evals\run_advisor_demo_readiness_phase1_audit.py --run-tag advisor-demo-readiness-phase1-dev` 通过，并输出 `advisor_demo_readiness_phase1_ready`
- `python evals\run_advisor_demo_dry_run_phase1_audit.py --run-tag advisor-demo-dry-run-phase1-dev` 通过，并输出 `advisor_demo_dry_run_phase1_ready`
...
- 特别保留 `advisor-demo-readiness-phase1-audit-*.json` 与 `advisor-demo-readiness-phase1-audit-*.md`
- 特别保留 `advisor-demo-dry-run-phase1-audit-*.json` 与 `advisor-demo-dry-run-phase1-audit-*.md`
- 记录演示使用的 thread_id
