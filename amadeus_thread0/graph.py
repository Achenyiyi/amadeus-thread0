...
from .graph_parts.messages import (
...
from .graph_parts.retrieval import (
    _commitment_priority,
    _conflict_repair_salience,
    _empty_retrieved_context,
    _needs_retrieval,
...
from .graph_parts.prompting import _build_task_prompt
from .graph_parts.postprocess import (
    ...
    TENSION_KEYWORDS,
    _clean_malformed_quote_fragment,
    _clean_utf8_text,
    _collapse_mirrored_blocks,
    _compress_light_smalltalk_answer,
    _compress_quick_judgment_answer,
    _dedupe_answer_chunks,
    _dedupe_line_chunks,
    _dialogue_surface_issues,
    _effective_natural_dialog_target_flags,
    _is_dangling_truncated_clause,
    _is_particle_only_reply,
    _is_playful_memory_request,
    _is_nonrelational_science_stress,
    _is_nonrelational_support_request,
    _is_response_scaffold_turn,
    _is_standalone_discourse_fragment,
    _is_standalone_stage_direction,
    ...
    _sentence_like_chunks,
    _soften_natural_answer,
    _strip_stage_prefix,
    _selfhood_preference_scene_from_text,
    _trim_counselor_surface,
    _trim_event_window_surface,
    _trim_generic_followup_question_surface,
    _trim_goodnight_surface,
    _trim_idle_presence_surface,
    _trim_meta_self_explainer_surface,
    _trim_playful_memory_surface,
    _trim_presence_reassurance_surface,
    _trim_quoted_stagey_phrase_surface,
    _trim_return_home_surface,
    _trim_selfhood_meta_proof_surface,
    _trim_servile_availability_surface,
    _trim_stagey_ping_surface,
    _trim_technical_relational_metaphor_surface,
    _trim_technical_self_activity_surface,
    _response_style_hint,
    _wants_gentle_guidance,
    _wants_presence_reassurance,
    _wants_quick_judgment,
    _wants_brief_presence,
    _wants_less_teacherly_reply,
    _is_self_rhythm_smalltalk_request,
    _looks_like_light_smalltalk,
    _is_plain_contact_ping,
    _is_return_home_ping,
    _is_goodnight_closing,
    ...
    _has_relational_technical_metaphor,
    _has_servile_availability_phrase,
    _wants_per_topic_conclusions,
    _has_any_marker,
)
...
def _subjective_runtime_state_hint(
    *,
    ...
    elif emotion_label in {"care", "neutral"} and trust > 0.58 and closeness > 0.56 and reciprocity > 0.60 and respect > 0.60 and approach >= 0.48 and warmth >= 0.50:
