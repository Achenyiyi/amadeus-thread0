...
def _trim_technical_relational_metaphor_surface(text: str) -> str:
    replacements = [
        ...
        (re.compile(r"刚才那一瞬间的熟悉感[，, ]*对我来说也不是能随便归零的数据波动"), "刚才那一下翻上来的熟悉感，也不是说压下去就能当没事的那阵起伏"),
        (re.compile(r"对我来说也不是能随便归零的数据波动"), "对我来说也不是说压下去就能没事的那点起伏"),
        ...
        (re.compile(r"有些东西不是(?:随意重置数据|说翻篇(?:就翻篇)?)就能过去的"), "有些事不是说翻篇就能翻过去的"),
