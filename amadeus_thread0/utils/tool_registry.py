...
def _iter_builtin_tools() -> Iterable[BaseTool]:
    ...
    return [
        ...
        builtin_tools.attach_repo_root_access,
        builtin_tools.browser_open_url,
        builtin_tools.browser_follow_link,
        builtin_tools.browser_list_tabs,
        builtin_tools.browser_select_tab,
        builtin_tools.browser_go_back,
        builtin_tools.browser_go_forward,
        builtin_tools.browser_reload,
        builtin_tools.browser_snapshot,
        builtin_tools.browser_click,
        builtin_tools.browser_fill,
        builtin_tools.browser_press_key,
        builtin_tools.browser_download_click,
        builtin_tools.browser_upload_file,
        builtin_tools.browser_begin_manual_takeover,
        builtin_tools.browser_capture_page_to_source_ref,
        ...
        builtin_tools.search_skills,
        builtin_tools.inspect_skill,
        builtin_tools.list_runtime_skills,
        builtin_tools.install_skill,
        builtin_tools.update_skill,
        builtin_tools.enable_skill,
        builtin_tools.disable_skill,
        builtin_tools.pin_skill,
        builtin_tools.unpin_skill,
