...
LLM_APPRAISAL_SOFT_CONFIDENCE_MIN = _env_float("AMADEUS_LLM_APPRAISAL_SOFT_CONFIDENCE_MIN", 0.5)
LLM_APPRAISAL_MAX_HISTORY_MESSAGES = _env_int("AMADEUS_LLM_APPRAISAL_MAX_HISTORY_MESSAGES", 6)
LLM_APPRAISAL_TIMEOUT_S = _env_int("AMADEUS_LLM_APPRAISAL_TIMEOUT_S", 12)
LLM_APPRAISAL_MODEL_MAX_RETRIES = _env_int("AMADEUS_LLM_APPRAISAL_MODEL_MAX_RETRIES", 0)
LLM_APPRAISAL_INVOKE_MAX_RETRIES = _env_int("AMADEUS_LLM_APPRAISAL_INVOKE_MAX_RETRIES", 0)
