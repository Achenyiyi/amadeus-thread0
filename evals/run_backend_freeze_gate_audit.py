...
def _build_check_specs(*, case_timeout_s: int, smoke_run_tag: str) -> list[dict[str, Any]]:
    return [
        ...
        {
            "id": "session_fabric_perception_contract",
            "title": "Session Fabric + Perception Contract",
            "category": "pytest",
            "blocking": True,
            "command": _python_cmd(
                "-m",
        ...
        {
            "id": "final_semantics_writeback_traceability",
            "title": "Final Semantics + Writeback Traceability",
            "category": "pytest",
            "blocking": True,
            "command": _python_cmd(
                "-m",
        ...
        {
            "id": "capability_presence_runtime",
            "title": "Capability Bus + Presence Runtime",
            "category": "pytest",
            "blocking": True,
            "command": _python_cmd(
                "-m",
                ...
                "tests/test_idle_event_context.py",
                "-q",
            ),
        },
        {
